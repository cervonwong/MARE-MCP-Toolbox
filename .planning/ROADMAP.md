...
**Plans**: 5 plans
  - [ ] 10-01-PLAN.md — Wave 0: Dockerfile binwalk3 migration + 13-file RED-stub test scaffold + in-container probe script (D-01, D-24, A1/A2/A3 resolution)
  - [ ] 10-02-PLAN.md — Wave 1 primitive: extraction.py core (env constants, extraction_dir, sidecar I/O, quarantine_symlinks, write_upload, two pure argv builders, two JobToolSpec registrations) (D-07..D-12, D-15, D-16, D-18, D-19)
...
| 10. Extraction Tier            | v1.1      | 0/5   | Not started | -          |
