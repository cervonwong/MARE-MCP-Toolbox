...
**Plans**: 3 plans
  - [ ] 06-01-PLAN.md — Wave-0 test scaffolding: register `slow` pytest marker + create RED test stubs (`test_runner.py`, `test_artifacts_io.py`) covering SC-1..SC-5, D-08, D-09, D-15, D-16
