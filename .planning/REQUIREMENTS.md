...
- [ ] **FOUND-01**: Agent edits to `mcp-gateway/src/` trigger a Docker image rebuild on the next `./run_docker.sh` invocation (F-1 carryover fix — content-hash includes gateway source)
